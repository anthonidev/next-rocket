...
const Home: NextPage = () => {
  return (
    <Layout title="Next Rocket" content="Next Rocket Peru es una empresa">
      <div >
        <div className=' relative bg-white dark:bg-dark-100'>
          <img
          ...
          <div className="relative max-w-screen-xl px-4 py-32 mx-auto lg:h-screen lg:items-center lg:flex">
            <div className="max-w-xl text-center sm:text-left">
              <h1 className="text-7xl text-indigo-500 font-extrabold sm:text-5xl">
                Next Rocket
              ...
              <p className="max-w-lg mt-4 sm:leading-relaxed sm:text-2xl font-roboto text-gray-200">
